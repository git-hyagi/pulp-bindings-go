...
// GetSlesAuthToken returns the SlesAuthToken field value if set, zero value otherwise.
func (o *RpmRpmRemoteResponse) GetSlesAuthToken() string {
	if o == nil || IsNil(o.SlesAuthToken) {
		var ret string
		return ret
	}
	return *o.SlesAuthToken
}
...
// SetSlesAuthToken gets a reference to the given string and assigns it to the SlesAuthToken field.
...
func (o RpmRpmRemoteResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SlesAuthToken) {
		toSerialize["sles_auth_token"] = o.SlesAuthToken
	}
