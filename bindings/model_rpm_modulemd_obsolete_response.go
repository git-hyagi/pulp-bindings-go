...
type RpmModulemdObsoleteResponse struct {
	...
	OverridePrevious string `json:"override_previous"`
	// Modulemd's context.
	ModuleContext string `json:"module_context"`
	// End of Life date.
	EolDate string `json:"eol_date"`
	// Obsolete by module name.
	ObsoletedByModuleName string `json:"obsoleted_by_module_name"`
	// Obsolete by module stream.
	ObsoletedByModuleStream string `json:"obsoleted_by_module_stream"`
}
...
func (o *RpmModulemdObsoleteResponse) GetObsoletedByModuleName() string {
	...
	return o.ObsoletedByModuleName
}
...
func (o *RpmModulemdObsoleteResponse) GetObsoletedByModuleStream() string {
	...
	return o.ObsoletedByModuleStream
}
...
func (o RpmModulemdObsoleteResponse) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["override_previous"] = o.OverridePrevious
	toSerialize["module_context"] = o.ModuleContext
	toSerialize["eol_date"] = o.EolDate
	toSerialize["obsoleted_by_module_name"] = o.ObsoletedByModuleName
	toSerialize["obsoleted_by_module_stream"] = o.ObsoletedByModuleStream
