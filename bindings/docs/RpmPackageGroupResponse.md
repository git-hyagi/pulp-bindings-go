...
**DisplayOrder** | **int64** | PackageGroup display order. | 
...
`func NewRpmPackageGroupResponse(id string, displayOrder int64, name string, description string, packages interface{}, descByLang interface{}, nameByLang interface{}, digest string, ) *RpmPackageGroupResponse`
