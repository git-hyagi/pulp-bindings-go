...
**DisplayOrder** | **int64** | Environment display order. | 
...
`func NewRpmPackageEnvironmentResponse(id string, name string, description string, displayOrder int64, groupIds interface{}, optionIds interface{}, descByLang interface{}, nameByLang interface{}, digest string, ) *RpmPackageEnvironmentResponse`
