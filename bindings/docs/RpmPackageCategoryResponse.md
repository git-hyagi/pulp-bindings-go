...
**DisplayOrder** | **int64** | Category display order. | 
...
`func NewRpmPackageCategoryResponse(id string, name string, description string, displayOrder int64, groupIds interface{}, descByLang interface{}, nameByLang interface{}, digest string, ) *RpmPackageCategoryResponse`
