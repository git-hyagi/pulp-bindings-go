...
**OverridePrevious** | **string** | Reset previous obsoletes. | 
**ModuleContext** | **string** | Modulemd&#39;s context. | 
**EolDate** | **string** | End of Life date. | 
**ObsoletedByModuleName** | **string** | Obsolete by module name. | 
**ObsoletedByModuleStream** | **string** | Obsolete by module stream. | 

## Methods

### NewRpmModulemdObsoleteResponse

`func NewRpmModulemdObsoleteResponse(modified string, moduleName string, moduleStream string, message string, overridePrevious string, moduleContext string, eolDate string, obsoletedByModuleName string, obsoletedByModuleStream string, ) *RpmModulemdObsoleteResponse`
