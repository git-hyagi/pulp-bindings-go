...
**BaseProductName** | **string** | Base Product name. | 
**BaseProductShort** | **string** | Base Product short name. | 
**BaseProductVersion** | **string** | Base Product version. | 
...
**Discnum** | **int64** | Disc number. | 
**Totaldiscs** | **int64** | Number of discs in media set. | 
...
`func NewRpmDistributionTreeResponse(headerVersion string, releaseName string, releaseShort string, releaseVersion string, releaseIsLayered bool, baseProductName string, baseProductShort string, baseProductVersion string, arch string, buildTimestamp float64, instimage string, mainimage string, discnum int64, totaldiscs int64, addons []AddonResponse, checksums []ChecksumResponse, images []ImageResponse, variants []VariantResponse, ) *RpmDistributionTreeResponse`
