...
`func NewRpmModulemdObsolete(modified string, moduleName string, moduleStream string, message string, overridePrevious string, moduleContext string, eolDate string, obsoletedByModuleName string, obsoletedByModuleStream string, snippet string, ) *RpmModulemdObsolete`
