...
type OrphansCleanup struct {
	...
	OrphanProtectionTime *int64 `json:"orphan_protection_time,omitempty"`
...
// GetOrphanProtectionTime returns the OrphanProtectionTime field value if set, zero value otherwise.
func (o *OrphansCleanup) GetOrphanProtectionTime() int64 {
	if o == nil || IsNil(o.OrphanProtectionTime) {
		var ret int64
		return ret
	}
	return *o.OrphanProtectionTime
}
...
func (o *OrphansCleanup) GetOrphanProtectionTimeOk() (*int64, bool) {
	...
	return o.OrphanProtectionTime, true
}
...
// SetOrphanProtectionTime gets a reference to the given int64 and assigns it to the OrphanProtectionTime field.
func (o *OrphansCleanup) SetOrphanProtectionTime(v int64) {
	o.OrphanProtectionTime = &v
}
...
func (o OrphansCleanup) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OrphanProtectionTime) {
		toSerialize["orphan_protection_time"] = o.OrphanProtectionTime
	}
