...
type RpmDistributionTreeResponse struct {
	...
	BaseProductShort string `json:"base_product_short"`
	// Base Product version.
	BaseProductVersion string `json:"base_product_version"`
	...
	Instimage string `json:"instimage"`
	// Relative path to Anaconda stage2 image.
	Mainimage string `json:"mainimage"`
	// Disc number.
	Discnum int64 `json:"discnum"`
	// Number of discs in media set.
	Totaldiscs int64 `json:"totaldiscs"`
...
func (o RpmDistributionTreeResponse) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["base_product_name"] = o.BaseProductName
	toSerialize["base_product_short"] = o.BaseProductShort
	toSerialize["base_product_version"] = o.BaseProductVersion
	toSerialize["arch"] = o.Arch
	toSerialize["build_timestamp"] = o.BuildTimestamp
	toSerialize["instimage"] = o.Instimage
	toSerialize["mainimage"] = o.Mainimage
	toSerialize["discnum"] = o.Discnum
	toSerialize["totaldiscs"] = o.Totaldiscs
