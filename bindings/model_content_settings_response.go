...
// GetContentOrigin returns the ContentOrigin field value if set, zero value otherwise.
func (o *ContentSettingsResponse) GetContentOrigin() string {
	if o == nil || IsNil(o.ContentOrigin) {
		var ret string
		return ret
	}
...
// SetContentOrigin gets a reference to the given string and assigns it to the ContentOrigin field.
