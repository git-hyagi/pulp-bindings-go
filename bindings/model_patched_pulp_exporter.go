...
// GetLastExport returns the LastExport field value if set, zero value otherwise.
func (o *PatchedPulpExporter) GetLastExport() string {
	if o == nil || IsNil(o.LastExport) {
		var ret string
		return ret
	}
	return *o.LastExport
...
// SetLastExport gets a reference to the given string and assigns it to the LastExport field.
...
func (o PatchedPulpExporter) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LastExport) {
		toSerialize["last_export"] = o.LastExport
	}
